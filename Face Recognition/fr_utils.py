...
from tensorflow.compat.v1.keras.layers import Conv2D, ZeroPadding2D, Activation, Input 
from tensorflow.compat.v1.keras.layers import concatenate,MaxPooling2D,AveragePooling2D
